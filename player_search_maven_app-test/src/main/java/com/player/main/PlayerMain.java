		...
		do {
			...
			case 2:	
				...
				try {
					...
					if (playerList!=null) {
						System.out.println("We found some player(s) by the name " + name + ". Details are: ");
				...
				break;
			case 3:
				System.out.println("Please enter Player age to get Player Details");
				...
				try {
					...
					if (playerList!=null) {
						System.out.println("We found some player(s) that are the age  " + age + ". Details are: ");
						System.out.println(playerList);
					}
			...
			case 4:
				...
				break;
			case 5:
				System.out.println("Please enter the player's contact number");
				
				try {
					Long contact = Long.parseLong(scanner.nextLine());
					Player player = playerSearchService.getPlayerByContactNumber(contact);
					if (player!=null) {
						System.out.println("We found a player by that contact number. Details are: ");
						System.out.println(player);
				...
				break;
			case 6:
				System.out.println("Please enter the player's teamname");
				...
				try {
					...
					if (playersListTeamName!=null & playersListTeamName.size()>0) {
						System.out.println("We found"+playersListTeamName.size()+"no of player/s in the DB with teamname + " +teamName +". Details are:");
